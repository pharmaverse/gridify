test_that("show on gridifyClass returns information to the console", {
  ...
  expect_equal(output, c(
    "Layout dimensions:", "  Number of rows: 3", "  Number of columns: 1",
    "", "Heights of rows:", "  Row 1: 0 lines", "  Row 2: 1 null",
    "  Row 3: 0 lines", "", "Widths of columns:", "  Column 1: 1 npc",
    "", "Object Position:", "  Row: 2", "  Col: 1", "  Width: 1", "  Height: 1",
    "", "Object Row Heights:", "  Row 2: 1 null", "", "Margin:", "  Top: 0.1 npc",
    "  Right: 0.1 npc", "  Bottom: 0.1 npc", "  Left: 0.1 npc", "",
    "Global graphical parameters:", "  Are not set", "", "Default Cell Info:",
    "  title:", "    row:1, col:1, text:NULL, mch:Inf, x:0.5, y:0.5, hjust:0.5, vjust:0.5, rot:0, ",
    "  footer:",
...
test_that("show on more complex gridifyClass returns information to the console", {
  ...
  expect_equal(output, c(
    ...
    "  Row 3: 0 lines", "", "Widths of columns:", "  Column 1: 1 npc",
    "", "Object Position:", "  Row: 2", "  Col: 1", "  Width: 1", "  Height: 1",
    "", "Object Row Heights:", "  Row 2: 1 null", "", "Margin:", "  Top: 1 mm",
    "  Right: 2 mm", "  Bottom: 3 mm", "  Left: 4 mm", "", "Global graphical parameters:",
    "  col: red ", "", "Default Cell Info:", "  title:",
    "    row:1, col:1, text:NULL, mch:Inf, x:0.5, y:0.5, hjust:0.5, vjust:0.5, rot:0, ", "  footer:",
    "    row:3, col:1, text:NULL, mch:Inf, x:0.5, y:0.5, hjust:0.5, vjust:0.5, rot:0, "
  ))
})
...
test_that("show on complex gridifyLayout returns information to the console", {
  test_layout <- complex_layout(global_gpar = grid::gpar(fontsize = 22))
  expect_s4_class(test_layout, "gridifyLayout")
  ...
  expect_equal(output, c(
    "gridifyLayout object", "---------------------", "Layout dimensions:",
    "  Number of rows: 6", "  Number of columns: 3", "", "Heights of rows:",
    "  Row 1: 0 lines", "  Row 2: 0 lines", "  Row 3: 0 lines",
    "  Row 4: 1 null", "  Row 5: 0 lines", "  Row 6: 0 lines",
    "", "Widths of columns:", "  Column 1: 0.333333333333333 npc",
    "  Column 2: 0.333333333333333 npc", "  Column 3: 0.333333333333333 npc",
    "", "Object Position:", "  Row: 4", "  Col: 1-3", "  Width: 1",
    "  Height: 1", "", "Object Row Heights:", "  Row 4: 1 null", "",
    "Margin:", "  Top: 0.1 npc", "  Right: 0.1 npc", "  Bottom: 0.1 npc",
    "  Left: 0.1 npc", "", "Global graphical parameters:", "  fontsize: 22 ", "",
    "Default Cell Info:", "  header_left:",
    "    row:1, col:1, text:NULL, mch:Inf, x:0.5, y:0.5, hjust:0.5, vjust:0.5, rot:0, ",
    "  header_middle:", "    row:1, col:2, text:NULL, mch:Inf, x:0.5, y:0.5, hjust:0.5, vjust:0.5, rot:0, ",
    "  header_right:", "    row:1, col:3, text:NULL, mch:Inf, x:0.5, y:0.5, hjust:0.5, vjust:0.5, rot:0, ",
    "  title:", "    row:2, col:13, text:NULL, mch:Inf, x:0.5, y:0.5, hjust:0.5, vjust:0.5, rot:0, ",
    "  subtitle:", "    row:3, col:13, text:NULL, mch:Inf, x:0.5, y:0.5, hjust:0.5, vjust:0.5, rot:0, ",
    "  note:",
    "    row:5, col:13, text:NULL, mch:Inf, x:0.5, y:0.5, hjust:0.5, vjust:0.5, rot:0, ",
    "  footer_left:",
