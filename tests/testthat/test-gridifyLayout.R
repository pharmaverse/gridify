...
test_that(
  ...
  ),
  {
    ...
    expect_identical(class_spec, c(
      nrow = "numeric", ncol = "numeric", heights = "unitOrSimpleUnit",
      widths = "unitOrSimpleUnit", margin = "unitOrSimpleUnit", global_gpar = "gpar",
      adjust_height = "logical", object = "gridifyObject", cells = "gridifyCells"
    ))
  }
)
...
test_that("unitOrSimpleUnit is unit or simpleUnit", {
  ...
  expect_true(methods::is(grid::unit(c(1, 2), c("npc", "cm")), "unitOrSimpleUnit"))
})
...
test_that("gridifyLayout setValidity tests", {
  ...
  expect_error(
    new(
      ...
      adjust_height = FALSE,
      object = gridifyObject(1, 1),
      cells = gridifyCells(a = gridifyCell(row = 1, col = 3), b = gridifyCell(row = 2, col = 2))
    ),
  ...
  expect_error(
    new(
      ...
      cells = gridifyCells(a = gridifyCell(row = 1, col = 2), b = gridifyCell(row = 2, col = 2))
    ),
    "less or equal to nrow: 2"
  )
  ...
  expect_warning(
    new(
      ...
      cells = gridifyCells(a = gridifyCell(row = 1:2, col = 2), b = gridifyCell(row = 2, col = 2))
    ),
  ...
  expect_warning(
    new(
      ...
      adjust_height = FALSE,
      object = gridifyObject(2, 2),
      cells = gridifyCells(a = gridifyCell(row = 1:3, col = 3), b = gridifyCell(row = 3, col = 3))
    ),
  ...
  expect_warning(
    new(
      ...
      adjust_height = FALSE,
      object = gridifyObject(2, 2),
      cells = gridifyCells(a = gridifyCell(row = 1:2, col = 3), b = gridifyCell(row = 3, col = 3))
    ),
    NA
  )
})
